...
void messageCb( const swarm::move1& cont_msg){
  ...
  move14 = cont_msg.move14;
    if(mode== 0) {
      //ROLL CH1
      if(move11==0){
        ppmEncoder.setChannel(0, ch1-100); //kiri
      }
      else if (move11==1){
        ppmEncoder.setChannel(0, ch1+100); //kanan
      }
      else if (move11==2){
      ...
      //PITCH CH2
      if(move12==0){
        ppmEncoder.setChannel(1, ch2-100); //mundur
      }
      else if (move12==1){
        ppmEncoder.setChannel(1, ch2+100); //maju
      }
      else if (move12==2){
      ...
      //THROTTLE CH3
      if(move13==0){
        ppmEncoder.setChannel(2, ch3-100);//turun
      }
      else if (move13==1){
        ppmEncoder.setChannel(2, ch3+100); //naik
      }
      else if (move13==2){
      ...
      //YAW CH4
      if(move14==0){
        ppmEncoder.setChannel(3, ch4-100); //kiri
      }
      else if (move14==1){
        ppmEncoder.setChannel(3, ch4+100); //kanan
      }
      else if (move14==2){
