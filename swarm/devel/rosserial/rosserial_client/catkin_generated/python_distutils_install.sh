...
echo_and_run cd "/home/bernard/swarm/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/bernard/swarm/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/bernard/swarm/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
