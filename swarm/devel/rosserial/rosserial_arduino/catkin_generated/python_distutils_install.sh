...
echo_and_run cd "/home/bernard/swarm/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/bernard/swarm/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/bernard/swarm/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
