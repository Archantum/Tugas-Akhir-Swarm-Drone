...
echo_and_run cd "/home/bernard/swarm/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/bernard/swarm/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/bernard/swarm/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
