...
echo_and_run cd "/home/bernard/swarm/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/bernard/swarm/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/bernard/swarm/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
