...
echo_and_run cd "/home/bernard/swarm/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/bernard/swarm/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/bernard/swarm/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
